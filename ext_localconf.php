...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks'][\Interritor\FormPdf\Task\CleanerTask::class] = [
    'extension' => 'form_pdf',
    ...
    'additionalFields' => \Interritor\FormPdf\Task\CleanerFieldProvider::class
];


$boot = function () {

    $GLOBALS['TYPO3_CONF_VARS']['FE']['eID_include']['pdfform'] = \Interritor\FormPdf\Ajax\PdfResponse::class . '::processRequest';
};
$boot();
unset($boot);
